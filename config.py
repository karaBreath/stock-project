...
class Config:
    ...
    WORLD_THEMES = {
        ...
        # ข่าวการเมือง/การทูตระหว่างประเทศ — มาจากไฟล์ Events (รหัส CAMEO)
        # ต้องมีธีมนี้แยกออกมา ไม่งั้นข่าวการเมืองถูกเหมาว่าเป็น "การค้า/ภาษี"
        # (เจอจริงจากผลรัน: เตหะราน เคียฟ กาซา ขึ้นเป็นสีการค้าทั้งหมด = ป้ายผิด)
        "geopolitics": ("การเมือง/การทูตโลก", "", "#adb5bd"),
    }
